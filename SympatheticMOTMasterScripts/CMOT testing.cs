...
public class Patterns : MOTMasterScript
{
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Ramp molasses power down after 1 ms 
        p.AddLinearRamp("aom2amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"], , (double)Parameters["MolassesPrincipalFinalAmplitude"]);
