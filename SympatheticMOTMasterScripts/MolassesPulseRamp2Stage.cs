...
// This script is for running grey with a two stage ramp from the MOT. 
...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["MolassesPrincipalIntermediateAmplitude"] = 1.7;
        Parameters["MolassesPrincipalFinalAmplitude"] = 1.69;
        Parameters["Stage1StartTime"] = 10;
        Parameters["OLFSwitchTime"] = 10;
        Parameters["Stage1Duration"] = 10;
        Parameters["Stage2Duration"] = 30;
        Parameters["MolassesRepumpDetuning"] = 802.0;
        Parameters["MolassesPulseLength"] = 50;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Stage 1 ramp
        p.AddLinearRamp("aom2amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["Stage1StartTime"], (int)Parameters["Stage1Duration"], (double)Parameters["MolassesPrincipalIntermediateAmplitude"]);

        //Stage 2 ramp
        p.AddLinearRamp("aom2amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["Stage1StartTime"] + (int)Parameters["Stage1Duration"], (int)Parameters["Stage2Duration"], (double)Parameters["MolassesPrincipalFinalAmplitude"]);
        //p.AddLinearRamp("D1EOMfrequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["Stage1StartTime"] + (int)Parameters["Stage1Duration"], (int)Parameters["Stage2Duration"], 802.5);
