...
// This script was for absorption imaging of the MOT with the d1 probe, using the new optical pumping aom
...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        //Imaging settings
        Parameters["absImageDetuning"] = 130.0;
        Parameters["absImagePower"] = 0.7;
        Parameters["backgroundImagePower"] = 0.7;
        ...
        Parameters["offsetlockvcofrequency"] = 9.165;//sets the frequency of the VCO 
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //Optical pumping
        p.Pulse((int)Parameters["MOTEndTime"] + (int)Parameters["ImageDelay"], -(int)Parameters["OPTimedelay"], (int)Parameters["OPPulseLength"], "aom4enable");
