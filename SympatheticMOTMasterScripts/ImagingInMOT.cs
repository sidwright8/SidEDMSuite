...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["PatternLength"] = 90000;//in units of 100microseconds.
        Parameters["MOTStartTime"] = 10000;
        Parameters["MOTLoadEndTime"] = 65000;
        ...
        Parameters["Frame0Trigger"] = 70005;
        ...
        Parameters["absImageRepumpDetuning"] = 814.3;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.DownPulse(85000, 0, 50, "CameraTrigger"); //background image - no light.
        p.DownPulse(89000, 0, 50, "CameraTrigger");
        return p;
    }
