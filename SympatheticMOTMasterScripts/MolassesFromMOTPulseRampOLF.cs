...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["offsetlockvcofrequency"] = 9.15;//-300MHz/V
        Parameters["OLFfinal"] = 8.85;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Ramp OLF after a hold time
        p.AddLinearRamp("offsetlockfrequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"], (int)Parameters["MolassesTimeForFullRamp"] , (double)Parameters["OLFfinal"]);
