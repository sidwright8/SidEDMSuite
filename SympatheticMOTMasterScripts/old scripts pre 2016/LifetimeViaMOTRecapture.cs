...
public class Patterns : MOTMasterScript
{
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.Pulse((int)Parameters["MagTrapEndTime"] + 199, 0, (int)Parameters["ExposureTime"] + 2, "aom3enable");
        p.DownPulse((int)Parameters["MagTrapEndTime"] + 200, 0, (int)Parameters["Frame0TriggerDuration"], "CameraTrigger");
