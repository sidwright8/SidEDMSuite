...
// This script is for running grey molasses after a MOT, ramping down the beam power some time after starting the pulse.  
...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["aom3Detuning"] = 180.8; // MOT cooling
        ...
        Parameters["MolassesPrincipalStartAmplitude"] = 6.0;
        Parameters["MolassesPrincipalFinalAmplitude"] = 0.5;
        Parameters["MolassesRampDownStart"] = 10;
        Parameters["MolassesTimeForFullRamp"] = 40;
        Parameters["MolassesRepumpDetuning"] = 802.0;
        Parameters["RampSwitchOffTime"] = 40;
        Parameters["offsetlockvcofrequency"] = 9.10;//-300MHz/V
        Parameters["MolassesRepumpAmplitude"] = 1.85;
        ...
        //Imaging settings
        Parameters["absImageDetuning"] = 191.5;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        p.PulseSwitchable((int)Parameters["MolassesStartTime"], 0, (int)Parameters["MolassesRampDownStart"] +(int)Parameters["RampSwitchOffTime"], "aom2enable", (bool)Parameters["DoMolassesPulse"]);

        //Imaging
        p.Pulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"], -2, 1, "aom3enable");
        p.Pulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"], -1, 100, "aom1enable");
        p.Pulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"], -2, 100, "D2EOMenable");
        p.DownPulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"], 0, 100, "CameraTrigger"); //take an image of the cloud after D1 stage
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Ramp molasses power down after a hold time
        p.AddLinearRamp("aom2amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"], (int)Parameters["MolassesTimeForFullRamp"] , (double)Parameters["MolassesPrincipalFinalAmplitude"]);

        //Taking the pictures
        p.AddAnalogValue("D2EOMfrequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"] - 3, (double)Parameters["absImageRepumpDetuning"]);
        p.AddAnalogValue("D2EOMamplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"] - 3, (double)Parameters["absImageRepumpAmplitude"]);
        p.AddAnalogValue("aom1frequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"] - 1, (double)Parameters["absImageDetuning"]);
        p.AddAnalogValue("aom1amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesRampDownStart"] + (int)Parameters["RampSwitchOffTime"] + (int)Parameters["ImageDelay"] - 1, (double)Parameters["absImagePower"]);
