...
public class Patterns : MOTMasterScript
{
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Switch molasses power midway through pulse
        p.AddAnalogValue("aom2amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPowerSwitchTime"], (double)Parameters["MolassesPrincipalFinalAmplitude"]);

        //Switch single photon detuning midway through pulse
        p.AddAnalogValue("offsetlockfrequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["OLFSwitchTime"], (double)Parameters["OLFfinal"]);
