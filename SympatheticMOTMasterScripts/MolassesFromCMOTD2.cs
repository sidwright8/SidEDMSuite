...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["MolassesRepumpDetuning"] = 799.0;
        Parameters["MolassesPulseLength"]= 30;
        Parameters["offsetlockvcofrequency"] = 0.0;//-300MHz/V
        Parameters["offsetlockHCval"] =0.0;//Should be same as on hardware controller, to prevent unlocking when remote control ends
