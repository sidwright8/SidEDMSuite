...
// This script is for running grey molasses after a MOT and observing the expansion after ramping down to a hold power over 1ms, 1ms after capture at high power. 
...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["RampDuration"] = 10; 
        Parameters["MolassesPrincipalHoldPower"] = 6.0;
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //Ramp the molasses power down to the hold power
        p.AddLinearRamp("aom2amplitude", (int)Parameters["MolassesStartTime"] + 10, (int)Parameters["RampDuration"], (double)Parameters["MolassesPrincipalHoldPower"]);
