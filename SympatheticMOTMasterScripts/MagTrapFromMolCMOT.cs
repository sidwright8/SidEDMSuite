...
public class Patterns : MOTMasterScript
{
    ...
    public Patterns()
    {
        ...
        Parameters["MolXShimCoilCurrent"] = 1.0;
        Parameters["MolYShimCoilCurrent"] = 6.5;
        Parameters["MolZShimCoilCurrent"] = 1.4;

        //Magnetic Trap settings
        Parameters["TopMagTrapCurrent"]= 0.7;
        Parameters["BottomMagTrapCurrent"] = 0.75;
        Parameters["MagTrapHoldTime"] = 25;
        Parameters["MagXShimCoilCurrent"] = 1.0;
        Parameters["MagYShimCoilCurrent"] = 6.5;
        Parameters["MagZShimCoilCurrent"] = 1.4;
    ...
    public override PatternBuilder32 GetDigitalPattern()
    {
        ...
        //Imaging
        p.Pulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"], -2, 1, "aom3enable");
        p.Pulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"], -1, 100, "aom1enable");
        p.Pulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"], -2, 100, "D2EOMenable");
        p.DownPulse((int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"]+(int)Parameters["ImageDelay"]+(int)Parameters["MagTrapHoldTime"], 0, 100, "CameraTrigger"); //take an image of the cloud after D1 stage
    ...
    public override AnalogPatternBuilder GetAnalogPattern()
    {
        ...
        //magnetic trap
        p.AddAnalogValue("TopTrappingCoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"], (double)Parameters["TopMagTrapCurrent"]);
        p.AddAnalogValue("BottomTrappingCoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"], (double)Parameters["BottomMagTrapCurrent"]);
        p.AddAnalogValue("TopTrappingCoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["MagTrapHoldTime"], 0.0);
        p.AddAnalogValue("BottomTrappingCoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["MagTrapHoldTime"], 0.0);
        p.AddAnalogValue("xcoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"], (double)Parameters["MagXShimCoilCurrent"]);
        p.AddAnalogValue("ycoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"], (double)Parameters["MagYShimCoilCurrent"]);
        p.AddAnalogValue("zcoilcurrent", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"], (double)Parameters["MagZShimCoilCurrent"]);


        //Taking the pictures
        p.AddAnalogValue("D2EOMfrequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"] - 3, (double)Parameters["absImageRepumpDetuning"]);
        p.AddAnalogValue("D2EOMamplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"] - 3, (double)Parameters["absImageRepumpAmplitude"]);
        p.AddAnalogValue("aom1frequency", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"] - 1, (double)Parameters["absImageDetuning"]);
        p.AddAnalogValue("aom1amplitude", (int)Parameters["MolassesStartTime"] + (int)Parameters["MolassesPulseLength"] + (int)Parameters["ImageDelay"] + (int)Parameters["MagTrapHoldTime"] - 1, (double)Parameters["absImagePower"]);
